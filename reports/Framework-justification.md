...
| **Knowledge / Retrieval** | **LlamaIndex** | Full-context payload dumping | Dumping raw historical transcripts into the prompt caused severe "Lost in the Middle" degradation and high latency. LlamaIndex provided measured semantic chunking, restoring our extraction recall to 86.11%. |
